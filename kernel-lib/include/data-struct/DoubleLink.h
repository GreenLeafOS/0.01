...
/************************************************************************/
template<unsigned int Max>
inline bool DoubleLink<Max>::Search(int id)
{
	int tmp = head;
...
/************************************************************************/
template<unsigned int Max>
inline bool DoubleLink<Max>::SearchBack(int id)
{
	int tmp = tail;
...
inline bool DoubleLink<Max>::InsertNext(int id,int index)
{
	...
	if (new_prev < 0 || new_prev >= Max || new_next < 0 || new_next >= Max) return false;
